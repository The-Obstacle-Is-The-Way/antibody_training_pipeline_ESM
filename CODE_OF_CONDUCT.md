...
1. When we are wrong, we promptly admit it.
   
2. If you disagree with an implementation, provide a biophysical rationale from first principles.
  
3. If we disagree and provide sound rationale that you disagree with, you are encouraged to fork the repository and provide proof of your implementation. 
   
4. It is okay to be wrong, because this is how we learn.
   
5. We don't gatekeep. If you genuinely want to learn and contribute, we help you onboard.
...
11. We write clean, tested, typed, linted code. Test-driven development is the standard.

12. We maintain respect. No harassment, no personal attacks. Disagree with ideas, not people.

13. When conflicts arise, remember: it's not you versus another. It's the team versus the problem. We're on the same side, united against our common goal. 
