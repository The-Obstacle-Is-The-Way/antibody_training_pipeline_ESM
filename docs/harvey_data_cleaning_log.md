...
Combining datasets...
Saving to test_datasets/harvey.csv...
...
Full list: `test_datasets/harvey/failed_sequences.txt` (453 total)
...
Generated by: `scripts/convert_harvey_csvs.py`
...
```
test_datasets/harvey/failed_sequences.txt      (453 lines)
```
...
**Scripts:**
1. `scripts/convert_harvey_csvs.py`
2. `preprocessing/process_harvey.py`

**Quality checks:**
```bash
# Ruff linting
python3 -m ruff check scripts/convert_harvey_csvs.py preprocessing/process_harvey.py
# Result: All checks passed!

# Black formatting
python3 -m black --check scripts/convert_harvey_csvs.py preprocessing/process_harvey.py
# Result: All done! 2 files would be left unchanged.

# Isort import sorting
python3 -m isort --check scripts/convert_harvey_csvs.py preprocessing/process_harvey.py
