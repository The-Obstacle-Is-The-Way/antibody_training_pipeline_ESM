...
Generated by: `preprocessing/harvey/step1_convert_raw_csvs.py`
...
Generated by: `preprocessing/harvey/step2_extract_fragments.py`
...
```bash
# Ruff linting
python3 -m ruff check preprocessing/harvey/step1_convert_raw_csvs.py preprocessing/harvey/step2_extract_fragments.py
# Result: All checks passed!

# Black formatting
python3 -m black --check preprocessing/harvey/step1_convert_raw_csvs.py preprocessing/harvey/step2_extract_fragments.py
# Result: All done! 2 files would be left unchanged.

# Isort import sorting
python3 -m isort --check preprocessing/harvey/step1_convert_raw_csvs.py preprocessing/harvey/step2_extract_fragments.py
