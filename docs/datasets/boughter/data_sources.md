...
## Document Purpose
This document specifies the exact requirements for processing the Boughter 2020 dataset according to the Novo Nordisk methodology described in Sakhnini et al. 2025 (https://doi.org/10.1101/2025.04.28.650927). All requirements are sourced directly from published papers without assumptions.
...
2. Sakhnini LI et al. (2025) "Prediction of Antibody Non-Specificity using Protein Language Models and Biophysical Parameters." bioRxiv. https://doi.org/10.1101/2025.04.28.650927
