...
- `test_datasets/boughter/` - Independent Boughter validation sets
...
**Datasets:**
- `test_datasets/jain/canonical/` - Jain benchmark test sets (86 antibodies for Novo parity)
- `test_datasets/jain/fragments/` - Fragment-specific test sets
...
**Datasets:**
- `test_datasets/harvey/processed/harvey.csv` - Full dataset (141,474 before ANARCI)
- `test_datasets/harvey/fragments/VHH_only_harvey.csv` - VHH-only (141,021 sequences)
...
**Datasets:**
- `test_datasets/shehata/processed/shehata.csv` - Full dataset (398 antibodies)
- `test_datasets/shehata/fragments/` - Fragment-specific test sets
