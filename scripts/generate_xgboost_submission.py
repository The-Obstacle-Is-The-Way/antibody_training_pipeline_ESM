...
print("=" * 80)
print("XGBOOST (Iteration 1B) (Iteration 1A): Deeper Trees + Faster Learning")
print("=" * 80)
...
xgb_params = {
    "n_estimators": 2000,
    "learning_rate": 0.03,
    "max_leaves": 64,  # Conservative (roadmap: start with 16)
...
output_dir = Path("ginkgo_submissions_xgboost_aggressive")
