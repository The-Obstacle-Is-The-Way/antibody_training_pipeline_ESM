...
print("=" * 80)
print("CATBOOST (Iteration 1C) (Iteration 1A): Deeper Trees + Faster Learning")
print("=" * 80)
...
catboost_params = {
    "n_estimators": 2000,
    "learning_rate": 0.03,
    "depth": 6,  # Conservative (roadmap: start with 4)
    "rsm": 0.8,
    "l2_leaf_reg": 3.0,
    "random_state": 42,
    "verbose": False,
...
output_dir = Path("ginkgo_submissions_catboost_aggressive")
