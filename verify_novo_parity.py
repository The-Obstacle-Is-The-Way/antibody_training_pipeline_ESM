...
def main():
    ...
    print(f"|---------------------|------------|------------|------------|")
    print(f"| Accuracy            | {accuracy:.4f}     | 0.6628     | {'✅ YES' if abs(accuracy-0.6628)<0.0001 else '❌ NO'} |")
    print(f"| Confusion Matrix    | [[{cm[0,0]},{cm[0,1]}],[{cm[1,0]},{cm[1,1]}]] | [[40,19],[10,17]] | {'✅ YES' if np.array_equal(cm, novo_cm) else '❌ NO'} |")
    print(f"| Non-spec FN         | {cm[0,1]:2d}         | 19         | {'✅ YES' if cm[0,1]==19 else '❌ NO'} |")
